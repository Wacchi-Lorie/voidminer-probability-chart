...
public class GT_Worldgenloader implements Runnable {
    ...
    public void run() {
        ...
        /*
         * TODO: custom GTNH OreMixes WARNING: NO DUPLICATES IN aName OR DEPRECATED
         * MATERIALS IN HERE. Materials can be
         * used unlimited, since achievements for Ores are turned off.
         */

        // aName, aDefault, aMinY, aMaxY, aWeight, aDensity, aSize, aOverworld, aNether,
        // aEnd, aPrimary, aSecondary,
        // aBetween, aSporadic
        new GT_Worldgen_GT_Ore_Layer(
                "ore.mix.neutronium",
                true,
        ...
        // DO NOT DELETE V THIS V - this is needed so that gregtech generates its Ore
        // Layer's first (the ones up there),
        // which can then be transformed into "GT_Worldgen_GT_Ore_Layer_Space". Also,
        // Reflexion is slow.
        try {
            ...
            // ClassNotFound is expected if Galactic Greg is absent, so only report if other
            // problem
